...
#For the Coswara dataset

#This code works fine in Colab
...
'''
coswara_data_dir = os.path.abspath('data/') # os.path.abspath('.') #Local Path of iiscleap/Coswara-Data Repo
...
dirs_extracted = set(map(os.path.basename,glob.glob('{}'.format(extracted_data_dir))))
